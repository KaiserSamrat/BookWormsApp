    ...
    public class ResetPasswordActivity extends AppCompatActivity {
        ...
        protected void onStart() {
            ...
            if (check.equals("settings")){
                ...
                titleQuestions.setText("Answer The following Security Question");
            ...
            else
            {
                ...
                ref.child("Security Questions").updateChildren(userDataMap).addOnCompleteListener( new OnCompleteListener<Void>() {
                    ...
                    public void onComplete(@NonNull Task<Void> task) {
                        ...
                        {
                            Toast.makeText(ResetPasswordActivity.this, "Successfully set security questions", Toast.LENGTH_SHORT).show();
                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        if(snapshot.exists())
                        {
                            ...
                            if(snapshot.hasChild("Security Questions"))
                            {
                                ...
                                {
                                    Toast.makeText(ResetPasswordActivity.this, "Your answer One is incorrect", Toast.LENGTH_SHORT).show();
                                }
                                else if(!ans2.equals(answer2))
                                {
                                    Toast.makeText(ResetPasswordActivity.this, "Your answer Two is incorrect", Toast.LENGTH_SHORT).show();
                                }
                                else
                                {
